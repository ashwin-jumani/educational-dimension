        ...
        <table class="w-full mt-7">
            ...
            <tbody class="divide-y divide-border mt-1">
                ...
                <tr>
                  ...
                  <!-- Add "false" so no display -->
                @if (isset($course->courseTags) && !empty($course->courseTags) && false)
                ...
                @endif
                  <!-- Add "false" so no display -->
                @if (isset($course->languages) && !empty($course->languages) && false)
                    <tr >
                        <td class="px-1 py-4 text-left rtl:text-right">
                            <div
                                class="flex items-center gap-2 area-description text-heading/70 !leading-none shrink-0">
                ...
                @endif
                <!-- Add "false" so no display -->
                @if ($course?->courseSetting?->is_certificate && false) 
                    <tr>
                        <td class="px-1 py-4 text-left rtl:text-right">
                            <div
                                class="flex items-center gap-2 area-description text-heading/70 !leading-none shrink-0">
                ...
                @endif
                <!-- Add the organization name if available -->
                ...
                <tr>
                    ...
                    <td class="px-1 py-4 text-right rtl:text-left">
                        <div class="text-primary text-xl !leading-none font-bold text-right shrink-0 flex items-center justify-end gap-1.5">
                            {{ $course->organization?->userable?->name }}
                ...
                <tr style="display:none">
                    <td class="px-1 py-4 text-left rtl:text-right" class="display:none">
                        <div class="flex items-center gap-2 area-description text-heading/70 !leading-none shrink-0">
                            <span class="text-heading dark:text-white text-lg font-bold mb-0.5">
                                {{ translate('Price') }}
                            </span>
                    ...
                    <td class="px-1 py-4 text-right rtl:text-left" class="display:none">

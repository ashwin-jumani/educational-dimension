...
<div class="swiper-slide">
    <div class="relative flex-center aspect-[1/1.16] overflow-hidden custom-transition group/course">
        <!-- PRICE -->
        <span class="badge b-solid badge-primary-solid font-bold rounded-none absolute top-4 right-4 rtl:right-auto rtl:left-4 z-10">
            {{ $badgeText }}
        </span>
        <!-- THUMBNAIL -->
        ...
        <!-- CONTENT -->
        <div class="absolute right-0 bottom-0 left-0 p-7 pt-10 bg-overlay-gradient translate-y-[65px] group-hover/course:bg-heading group-hover/course:h-auto group-hover/course:translate-y-0 overflow-hidden shrink-0 custom-transition">

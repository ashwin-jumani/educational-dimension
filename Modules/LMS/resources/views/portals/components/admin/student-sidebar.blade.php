<div id="app-drawer" class="app-menu flex flex-col bg-white dark:bg-dark-card w-app-menu fixed top-0 left-0 rtl:left-auto rtl:right-0 bottom-0 -translate-x-full rtl:translate-x-full group-data-[sidebar-size=sm]:min-h-screen group-data-[sidebar-size=sm]:h-max border-r-2 rtl:border-r-0 rtl:border-l-2 border-primary-400 xl:border-none xl:!translate-x-0 rounded-r-15 rtl:rounded-r-none rtl:rounded-l-15 xl:!rounded-15 xl:group-data-[sidebar-size=lg]:w-app-menu xl:group-data-[sidebar-size=sm]:w-app-menu-sm xl:group-data-[sidebar-size=sm]:absolute xl:group-data-[sidebar-size=lg]:fixed xl:top-4 xl:left-4 rtl:xl:left-auto rtl:xl:right-4 xl:group-data-[sidebar-size=lg]:bottom-4 xl:group-data-[theme-width=box]:left-auto rtl:xl:group-data-[theme-width=box]:right-auto dk-theme-card-square z-backdrop duration-300" tabindex="-1">

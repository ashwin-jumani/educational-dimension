            ...
            <div class="col-span-full lg:col-span-6 card">
                <div class="leading-none">
                    ...
                    <input type="text" name="title" value="{{ $translations['title'] ?? ($course->title ?? '') }}"
                        id="courseTitle" placeholder="{{ translate('Course Title') }}" class="form-input">
                ...
                @if ($isAdmin || $isOrganization)
                    <div class="leading-none mt-6">
                        ...
                        <select class="js-example-basic-single" name="instructors[]" id="instructorOption">
                            <option disabled selected>{{ translate('Select Instructor') }}</option>
            ...
            <div class="col-span-full lg:col-span-6 card">
                ...
                <div class="leading-none">
                    ...
                    <select name="languages[]" multiple="true" id="courseLanguage"
                        ...
                        <option value="1" selected>{{ translate('English') }}</option>
                ...
                <div class="leading-none mt-6">
                    ...
                    <select name="time_zone_id"
                        ...
                        <option></option>
                        <option value="6" selected>{{ translate('Eastern Standard Time') }}</option>

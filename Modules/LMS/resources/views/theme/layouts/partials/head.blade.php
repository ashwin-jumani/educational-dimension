@php
    ...
    $defaultFavIcon =
        isset($logo['fav_icon']) && fileExists('lms/theme-options', $logo['fav_icon']) == true
            ? asset("storage/lms/theme-options/{$logo['fav_icon']}")
...
<head>
    ...
    <title>{{ $backendSetting['app_name'] ?? translate('Educational Dimension') }}</title>

                ...
                <div class="dashkit-tab-pane !block" data-tab="asStudent">
                    <form action="{{ route('auth.register') }}" class="form" method="POST">
                        ...
                        <div class="grid grid-cols-2 gap-x-3 gap-y-5">
                            ...
                            <div>
                                <!-- add option button with label "Are you a licensed RN/LVN/PLN" with option "Yes" and "No" -->
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="std_is_license" name="is_license">
                                    <label class="form-check-label" for="std_is_license">
                                        {{ translate('Are you a licensed RN/LVN/PLN?') }}
                                    </label>
                                </div>  
                            </div>

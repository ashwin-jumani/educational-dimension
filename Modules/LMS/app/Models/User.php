...
class User extends Authenticatable
{
    ...
    public function orgBundles(): HasMany
    {
        return $this->hasMany(CourseBundle::class, 'organization_id');
    }

    public function instructorBundles(): HasMany
    {
        return $this->hasMany(CourseBundle::class, 'instructor_id');
    }
    // public function
    /**
